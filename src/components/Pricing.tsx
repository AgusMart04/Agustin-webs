...
const plans = [
  {
    ...
    color: "green",
    features: [
      "Página web simple (puede ser landing o estructura básica)",
  ...
  },
  {
    ...
    color: "yellow",
    features: [
      "Landing o web con varias secciones",
      "Formulario de contacto",
      "Diseño más trabajado y personalizado",
      "Optimizada para celular",
      "Mejor estructura para convertir clientes",
    ],
    priceEUR: 300,
    priceUSD: 360,
  ...
  },
  {
    ...
    color: "blue",
    features: [
      "Web completa con funcionalidades avanzadas",
      "Sistema de reservas o turnos",
      "Integraciones (mapa, redes, etc.)",
      "Diseño totalmente personalizado",
      "Pensada para automatizar y escalar el negocio",
    ],
    priceEUR: 500,
    priceUSD: 600,
